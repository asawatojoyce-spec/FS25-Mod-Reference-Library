...
source(g_currentModDirectory .. "src/ELS_loanType.lua")
...
function convertIngameLoans()
    for _, farm in pairs(g_farmManager:getFarms()) do
        if farm.loan > 0 then
            ...
            loan:init(farmId, amount, g_els_loanManager.loanManagerProperties.loanInterest, 3, false)
...
function init()
    ...
    InGameMenuStatisticsFrame.hasPlayerLoanPermission = Utils.overwrittenFunction(InGameMenuStatisticsFrame.hasPlayerLoanPermission, hasPlayerLoanPermission)
